...
plotAltVsRef.plotly <- function (ref, alt){
  ...
  plot_ly(x = ~ref, y = ~alt, type = "scatter", mode = "markers",
          ...
          marker = list(size = 12, line = list(color = "black", width = 0.3),
